...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupButtonNotes(scale: String) {
        ...
        val buttonE_6th_open: Button = findViewById(R.id.button_e_6th_open)
        buttonE_6th_open.setOnClickListener {
        ...
        buttonCSharp_6th.setOnClickListener {
            setupMediaPlayer(notesMap["C#"] ?: R.raw.c_sharp_6th)
            playNote()
        }
    ...
    private fun getNotesForScale(scale: String): Map<String, Int> {
        ...
        return when (scale) {
            "Major" -> mapOf("E" to R.raw.e_6th_open, "F" to R.raw.f_6th, "F#" to R.raw.f_sharp_6th
            , "G" to R.raw.g_6th, "G#" to R.raw.g_sharp_6th, "A" to R.raw.a_6th, "A#" to R.raw.a_sharp_6th
            , "B" to R.raw.b_6th, "C" to R.raw.c_6th, "C#" to R.raw.c_sharp_6th) // Example mapping
            else -> emptyMap()
        }
    }
